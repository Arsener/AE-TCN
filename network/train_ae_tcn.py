...
def create_model(file):
    ...
    with open(
            os.path.join(
                args.save_path, 'ae_tcn_hyperparameters.json'
            ), 'w'
    ) as fp:
        json.dump(params, fp)
...
if __name__ == '__main__':
    ...
    early_stopping = EarlyStopping(params['early_stopping'], path=os.path.join(args.save_path, '{}_AE_TCN.pth'.format(dataset)))
